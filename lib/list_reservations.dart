    ...
    return new Scaffold(
      ...
      body: Column(children: [
        Row(
          ...
          children: [
            IconButton(icon: Icon(Icons.chevron_left), onPressed: () => {}, iconSize: 30.0, color: Colors.grey,),
            Expanded(child: Center(child: Text(DateFormat("yyyy-MM-dd").format(widget.currentDate)),),),
            IconButton(icon: Icon(Icons.chevron_right), onPressed: () => {},iconSize: 30.0, color: Colors.grey,)
          ],
        ),
      ],),
    );
